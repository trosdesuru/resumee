    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
        <div className="p-6 rounded-lg text-white shadow-lg flex flex-col justify-center max-w-md mx-auto">
            ...
            <p className="font-jetbrains text-md text-left">
                Muy buenas! Mi nombre es Eduard Hernández, desarrollador <span className="bg-gray text-yellow-400 px-1 py-0.5 rounded-md font-mono">full-satck</span> con experiencia en diseño UX | UI. 
            ...
            Como un <span className="bg-gray text-yellow-400 px-1 py-0.5 rounded-md font-mono">callback</span> que siempre vuelve a dar una segunda oportunidad.
            </p>
